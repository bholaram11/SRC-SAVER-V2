...
async def status_command(client, message):
    ...
    status_text = (
        ...
        "**⏱️ Flood Prevention:**\n"
        f"• Current Delay: `{fp_stats['current_delay']}`\n"
        f"• Utilization: `{fp_stats['current_utilization']}`\n"
        f"• Total Requests: `{fp_stats['total_requests']}`\n"
        f"• Total Floods: `{fp_stats['flood_waits']}`\n\n"
